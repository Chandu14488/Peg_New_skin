...
{
    [TestClass]
    public class RevenueAdjustmentForSaleManagerAddAmount : DriverTestCase
    {
        [TestMethod]
        public void revenueAdjustmentForSaleManagerAddAmount()
        {
...
//################################# CREATE A agent   #############################################
   ...
   //         saleAgentRevenueAdjustmentHelper.Select("SelectStatusAdjtmnt","");
            ...
            if (saleAgentRevenueAdjustmentHelper.IsElementPresent(loc))
            {
                ...
                //EnterAdjustmentName
                saleAgentRevenueAdjustmentHelper.TypeText("EnterAdjustmentName", "SaleAdjustment");
