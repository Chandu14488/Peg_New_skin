...
{
    [TestClass]
    public class RelpacePDFForPDFTemplate : DriverTestCase
    {
        [TestMethod]
        public void relpacePDFForPDFTemplate()
        {
            ...
            //Click Replace link
            pDFTemplateAdminHelper.ClickElement("ClickOnReplaceLink");
            pDFTemplateAdminHelper.WaitForWorkAround(3000);
            ...
            //SaveReplaceTemplate
            pDFTemplateAdminHelper.ClickElement("SaveReplaceTemplate");
            pDFTemplateAdminHelper.WaitForWorkAround(9000);
   ...
   //         pDFTemplateAdminHelper.AcceptAlert();
            pDFTemplateAdminHelper.WaitForWorkAround(3000);
            pDFTemplateAdminHelper.VerifyPageText("PDF fields mapped successfully.");
