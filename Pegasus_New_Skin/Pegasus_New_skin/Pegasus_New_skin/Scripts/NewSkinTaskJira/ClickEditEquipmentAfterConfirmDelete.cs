...
//################################# Create Equipments #############################################
      ...
      //      equiomentHelperAdmin.ClickElement("ClickOn2CheckBox");
            ...
            //SearchEquipmenmt
            equiomentHelperAdmin.TypeText("SearchEquipmenmt", "TestEquip");
            equiomentHelperAdmin.WaitForWorkAround(3000);
            ...
            //ClcikDeleteEq
            equiomentHelperAdmin.ClickElement("ClcikDeleteEq");

            //Accpet Alert
            equiomentHelperAdmin.AcceptAlert();

            //equiomentHelperAdmin
            equiomentHelperAdmin.ClickElement("ClickOnEditEquip");
            equiomentHelperAdmin.WaitForWorkAround(3000);
