...
{
    [TestClass]
    public class PermanentlyDeletePDFTemplate : DriverTestCase
    {
        [TestMethod]
        public void permanentlyDeletePDFTemplate()
        {
         ...
         //   GetWebDriver().Navigate().GoToUrl("https://www.pegasus-test.com/selcorp/seloffice/pdf_templates");
            ...
            pDFTemplateAdminHelper.ClickElement("ClickOnDeleteIcon");
            pDFTemplateAdminHelper.AcceptAlert();
            pDFTemplateAdminHelper.WaitForWorkAround(3000);

            //PDF Template Restored Successfully.
            pDFTemplateAdminHelper.WaitForText("PDF Template Permanently Deleted.", 30);
