...
{
    [TestClass]
    public class RevenueAdjustmentSaleAgentRemoveFlat : DriverTestCase
    {
        [TestMethod]
        public void revenueAdjustmentSaleAgentRemoveFlat()
        {
     ...
     //       saleAgentRevenueAdjustmentHelper.TypeText("EnterAgentName", "Sale Agent Revenue Adjustment Tester");
      ...
      //      saleAgentRevenueAdjustmentHelper.Select("SelectStatusAdjtmnt","");
            ...
            if (saleAgentRevenueAdjustmentHelper.IsElementPresent(loc))
            {
                ...
                //EnterAdjustmentName
                saleAgentRevenueAdjustmentHelper.TypeText("EnterAdjustmentName", "Sale Agent Remove  Flat");
